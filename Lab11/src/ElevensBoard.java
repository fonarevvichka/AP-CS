...
public class ElevensBoard extends Board {
	...
	public boolean isLegal(List<Integer> selectedCards) {
		...
		if (selectedCards.size() == 2) {
			return findPariSum11(selectedCards).size() > 0;
	...
	public boolean anotherPlayIsPossible() {
		...
		return findPariSum11(cIndexes).size() > 0 || findJQK(cIndexes).size() > 0;
	}
	 ...
	 */
	private List<Integer> findPariSum11(List<Integer> selectedCards) {
		/* *** TO BE CHANGED INTO findPairSum11 IN ACTIVITY 11 *** */
		List<Integer> cIndexes = new ArrayList<Integer>();
	...
	public boolean playIfPossible() {
        return anotherPlayIsPossible() && (playJQKIfPossible() || playPairSum11IfPossible());
	}
	...
	private boolean playPairSum11IfPossible() {
	    List<Integer> playableCards = findPariSum11(cardIndexes());
	...
	private boolean playJQKIfPossible() {
        List<Integer> playableCards = findJQK(cardIndexes());
